...
public class RemoveProjectilePacket extends Packet {
	private int id;
	
	public RemoveProjectilePacket(int id) {
	...
	public RemoveProjectilePacket(boolean construct, byte[] bytes, int length) {
